...
USER MAPPING
       ...
       If  a  strong  interoperation with Windows is needed, the mapping has to be defined for each user and group known to both system, and the SIDs used by Windows has to be collected.
