...
DESCRIPTION
       parallel-scp  is  a  program  for  copying  files in parallel to a number of hosts using the scp program.  It provides features such as passing a password to scp, saving output to
