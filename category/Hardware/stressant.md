...
EXAMPLES
   ...
   Wiping disks
       ...
       As mentioned above, the stressant commandline tool can be used to directly wipe a disk with the fio(1) command which is actually a disk-testing command that  is  abused  for  that
