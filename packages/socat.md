...
## ENVIRONMENTVARIABLES
        ...
        SOCAT_OPENSSL_X509_COMMON## NAME(output)
        ...
        LOG NAME(input)
               ...
               With options su and su-d, LOG## NAMEis set to the given user name.
 
        USER (input)
               Is used as name for the socks client user name if no socksuser is given and LOG## NAMEis empty.
